...
class MutantsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mutant" do
    assert_difference('Mutant.count') do
      post mutants_url, params: { mutant: { name: @mutant.name, power: @mutant.power } }, as: :json
    end
  ...
  test "should update mutant" do
    patch mutant_url(@mutant), params: { mutant: { name: @mutant.name, power: @mutant.power } }, as: :json
    assert_response 200
  end
